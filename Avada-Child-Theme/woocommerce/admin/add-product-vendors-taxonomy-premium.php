...
<div class="form-field">
    ...
    <label for="yith_vendor_youtube_video">Video YouTube</label>

    <span class="yt_v_span">https://www.youtube.com/embed/</span>
    <input type="text" id="yt_v_input" class="regular_text" name="yith_vendor_data[yt_video]" />
...
<div class="form-field">
    ...
    <div class="yith-vendor-commission">
        ...
        <label class="yith_vendor_commission_label" for="yith_vendor_commission"><?php _e('Category:', 'yith-woocommerce-product-vendors');?></label>
    ...
    <span class="description">Definisci la categoria del venditore.</span>
