 ...
 * Questo file viene caricato nella pagina "Modifica venditore" dopo la sezione "Avatar"
...
<tr class="form-field">
    ...
    <th scope="row" valign="top">
        ...
        <label for="yith_vendor_youtube_video">Video YouTube (opzionale)</label>

    </th>

    <td>

        <span class="yt_v_span">https://www.youtube.com/embed/</span>
        <input type="text" id="yt_v_input" class="regular_text" name="yith_vendor_data[yt_video]" value="<?php echo $vendor->yt_video; ?>" />
...
<tr class="form-field">
    ...
    <th scope="row" valign="top">
        ...
        <label for="custom_taxonomy_category_vsb">Categoria:</label>
        <span><?php echo "(" . $vendor->vendor_category . ")"; ?></span>
    </th>

    <td>

        <input type="radio" name="yith_vendor_data[vendor_category]" value="parrucchiere"> Parrucchiere<br>
        <input type="radio" name="yith_vendor_data[vendor_category]" value="palestre"> Palestre
...
<tr class="form-field">
    <th scope="row" valign="top">
        <label for="yith_vendor_registration_date"><?php _e( 'Corrieri', 'yith-woocommerce-product-vendors' ); ?></label>
    </th>
    <td>
        <input type="text" class="regular-text" name="yith_vendor_data[carrier]" id="yith_vendor_carrier" value="<?php echo $vendor->carrier ?>" /><br />
        <br />
        <span class="description"><?php _e( 'Il corriere legato al vendor', 'yith-woocommerce-product-vendors' ); ?></span>
    </td>
</tr>
